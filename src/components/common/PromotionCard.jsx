...
export default function PromotionCard({ promo }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-border group shrink-0 w-[280px] sm:w-[340px]">
      <Image src={promo.banner} alt={promo.title} fittingType="fill" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-50 transition" />
